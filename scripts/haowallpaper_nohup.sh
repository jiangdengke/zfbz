...
print(f"JOB_PHASE_MODE = {merged.get('JOB_PHASE_MODE', 'all')!r}")
print(f"RELAY_LIMIT_WAIT = {merged.get('RELAY_LIMIT_WAIT', '600')}")
print(f"RELAY_LIMIT_MAX_WAIT_ROUNDS = {merged.get('RELAY_LIMIT_MAX_WAIT_ROUNDS', '12')}")
